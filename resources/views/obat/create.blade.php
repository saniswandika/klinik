    ...
    <div class="card">
        ...
        <div class="card-body shadow-lg">
            ...
            <div class="form-outline mb-4">
                ...
                <input type="text" id="form6Example3" class="form-control" name="nama_obat"/>
                        <input type="hidden" value="1" >
            </div>
            <div class="form-outline mb-4">
                <label class="form-label" for="form6Example3">Harag Obat</label>
                <input type="text" id="form6Example3" class="form-control" name="harga_obat"/>
            </div>
            <div class="card-footer">
                ...
                <div class="d-grid gap-2">
                    ...
                    <a href="{{ route('obat.index') }}" class="btn btn-default" type="button">Batal</a>
              </div>
            </div>
