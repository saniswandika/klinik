        ...
        <div class="card-body shadow-lg">
            ...
            <div class="form-outline mb-4">
                ...
                {{-- <div class="form-outline mb-4">
                    ...
                    @else
                    <textarea class="form-control" id="form6Example7" rows="4" name="Alamat">{{Auth::user()->alamat }}</textarea>
                    @endif
                ...
                <div class="row mb-4">
                    <div class="col">
                      <div class="form-outline">
                        ...
                        <input type="date" id="form6Example1" class="form-control" value="{{ \Carbon\Carbon::now()->format('Y-m-d') }}" name="tanggal_pendaftaran" />
                      </div>
                    </div>
                    <div class="col">
                        <div class="form-outline">
                            <label class="form-label" for="form6Example1">Waktu Pendaftaran</label>
                            <input type="time" id="form6Example1" class="form-control" value="{{ \Carbon\Carbon::now('Asia/Jakarta')->format('H:i') }}" name="waktu_pendaftaran" />
                        </div>
                    </div>
                </div>
                <div class="row mb-4">
                    <div class="col">
                      <div class="form-outline">
                        ...
                        <input type="date" id="form6Example1" class="form-control" value="{{ \Carbon\Carbon::now()->format('Y-m-d') }}" name="tanggal_antrian"/>
                      </div>
                    </div>
                    <div class="col">
                        <div class="form-outline">
                            <label class="form-label" for="form6Example1">Waktu Antrian</label>
                            <input type="time" id="form6Example1" class="form-control" value="{{ \Carbon\Carbon::now('Asia/Jakarta')->format('H:i') }}" name="waktu_antrian" />
                          </div>
                    </div>
                </div>
                ...
                {{-- <div class="form-outline mb-4">
                    ...
                    <input type="text" id="form6Example3" class="form-control" value="vital sign" readonly name="status" />
                </div> --}}
