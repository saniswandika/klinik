                                ...
                                // },   
                                {
                                    ...
                                    "mRender": function(data, type, row) {
                                        return'<div class="btn-group" role="group" aria-label="Actions">' +
                                                '<a class="btn btn-success btn-sm" href="/proses-tindak-medis/' + data.id + '">' +
                                                '<i class="fas fa-eye"></i> proses Pemeriksaan Dokter</a>' +
                                ...
                                },
                                {
                                    ...
                                    "mRender": function(data, type, row) {
                                        return '<div class="btn-group" role="group" aria-label="Actions">' +
                                                ...
                                                '<i class="fas fa-eye"></i> Details</a>' +
                                                '<form action="/tindakan_medis/' + data.id_tindakan_medis + '" method="POST" style="display:inline">' +
                                                    '@csrf' +
                                                    '@method("DELETE")' +
                                                    '<button type="submit" class="btn btn-danger btn-sm">' +
                                                    '<i class="fas fa-trash"></i> Hapus Data</button>' +
                                                '</form>' +
                                                '<div class="btn-group" role="group" aria-label="Actions">'+
                                                '<a class="btn btn-primary btn-sm" href="/tindakan_medis/'+data.id_tindakan_medis +'/edit""><i class="far fa-edit"></i></i>   Edit </a>' +
                                                '</div>';
                                    }
                                }
                            ],
