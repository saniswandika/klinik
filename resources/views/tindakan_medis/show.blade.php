        ...
        <div class="row p-3 d-flex justify-content-center">
            <div class="card card-primary card-outline col-xl-12 col-md-6 col-sm-6 p-3 " style="margin-right: 20px;">
                <div class="card-body box-profile ">
                    ...
                    <ul class="list-group list-group-unbordered mb-3 center">
                        <table width="100%" height="100%" class="table border border-2"> 
                            ...
                            <tr>
                                ...
                                <td  width="1px">:</td>
                                <td>{{ $tindakan_medis->jenis_tindakan }}</td>
                            </tr>
                            <tr>
                                <td width="1px">Hasil Tindakan</td>
                                <td  width="1px">:</td>
                                <td>{{ $tindakan_medis->hasil_tindakan }}</td>
                            </tr>
                            <tr>
                            ...
                            <tr>
                                ...
                                <td  width="1px">:</td>
                                <td>{{ $tindakan_medis->tanggal_tindakan }}</td>
                            </tr>
                            <tr>
                    ...
                    <ul class="list-group list-group-unbordered mb-3 center">
                        <a href="{{ route('home') }}" class="btn btn-default" type="button">Kembali</a>
                    </ul>
                    @else
                    <ul class="list-group list-group-unbordered mb-3 center">
                        <a href="{{ route('tindakan_medis.index') }}" class="btn btn-default" type="button">Kembali</a>
                    </ul>
                    @endif
                    {{-- <ul class="list-group list-group-unbordered mb-3 center">
                        <a href="{{ route('tindakan_medis.index') }}" class="btn btn-default" type="button">Kembali</a>
